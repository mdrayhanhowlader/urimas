...
$_LOGO_DIR        = __DIR__ . '/assets/images/logo/';
$_logo_image      = $settings['logo_image'] ?? '';
$logo_img_url     = ($_logo_image && file_exists($_LOGO_DIR.$_logo_image)) ? 'assets/images/logo/'.htmlspecialchars($_logo_image) : '';
